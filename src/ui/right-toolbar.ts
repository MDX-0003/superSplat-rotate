...
class RightToolbar extends Container {
    constructor(events: Events, tooltips: Tooltips, args = {}) {
        ...
        const gtCamera = new Button({
            id: 'right-toolbar-gt-camera',
            class: 'right-toolbar-toggle'
        });
        ...
        gtCamera.dom.appendChild(createSvg(cameraPanelSvg));
        ...
        tooltips.register(gtCamera, tooltip('tooltip.right-toolbar.gt-camera'), 'left');
        ...
        gtCamera.on('click', () => events.fire('gtCameraPanel.open'));
        ...
        events.on('viewPanel.visible', (visible: boolean) => {
            ...
            gtCamera.class[visible ? 'add' : 'remove']('active');
        });
    }
}
